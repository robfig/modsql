...
// getFilenames returns the names for the files.
func getFilenames(eng sqlEngine) (goFilename, sqlFilename string) {
	name, err := os.Getwd()
	if err != nil {
		log.Fatal(err)
	}
	...
	return fmt.Sprintf("data-%s.go", name),
		fmt.Sprintf("data-%s_%s.sql", name, eng.shortString())
}
