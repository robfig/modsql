...
INSERT INTO types (t_int, t_int8, t_int16, t_int32, t_int64, t_float32, t_float64, t_string, t_rune, t_bool) VALUES(1, 8, 16, 32, 64, 1.32, 1.64, 'one', 'Z', 1);
INSERT INTO default_value (id, d_bool, d_int8, d_float32, d_string, d_rune) VALUES(1, 0, 10, 10.1, 'foo', 'z');
COMMIT;
